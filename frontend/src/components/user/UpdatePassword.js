...
import { resetUpdate } from "../../actions/userActions";
...
export default function UpdatePassword(){
    ...
    const submitHandler = (e) => {
        ...
        const data = {
            oldPassword: oldPassword,   // ✅ Use correct camelCase as expected in backend
            password: password
        };

        dispatch(updatePasswordAction(data)); // Pass plain JS object
    };
    ...
    useEffect(()=>{
        if (isUpdated) {
                ...
                setOldPassword('');
                setPassword('');
                dispatch(resetUpdate()); // ✅ reset the flag
            }
