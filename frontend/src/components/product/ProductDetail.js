...
export default function ProductDetail(){
    ...
    const {product = {}, isReviewSubmitted, error,loading} = useSelector((state)=>state.productState);
        ...
        <Fragment>
            {loading  ? 
                ...
                <div className="col-12 col-lg-5 mt-5">
                    ...
                    <p id="product_price">{product.price} LKR</p>
                        ...
                        <div className="rating w-50">
                            ...
                            <Modal show={show} onHide={handleClose}>
                                ...
                                <Modal.Body>
                                    ...
                                    <textarea  onChange={(e)=>setComment(e.target.value)} name="review" id="review" className="form-control mt-3" placeholder="Enter your review here">
